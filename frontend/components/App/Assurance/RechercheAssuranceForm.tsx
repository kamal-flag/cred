...
function RechercheAssuranceForm({ searchData }: Props) {
  const {
    register,
    reset,
    handleSubmit,
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex items-start">
          <div className="flex flex-col w-full md:w-1/2">
            <div className="labelForm m1-2">Libellé</div>
            <input {...register('libelle')} type="text" className="inputForm" />
          </div>
        </div>
...
export default RechercheAssuranceForm;
