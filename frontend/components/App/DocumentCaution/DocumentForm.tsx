...
import {
  schemaAssuranceValidation,
  schemaDocumentCautionValidation,
} from '../../../config/yupSchemaValidation';
...
function DocumentCautionForm({
  ...
  const {
    ...
    resolver: yupResolver(schemaDocumentCautionValidation),
  });
  ...
  return (
    <Modal
      titleModal="Formulaire des documents de caution"
      openModal={showModal}
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="form">
        <div className="flex flex-wrap">
          <div className="w-full">
            <label className="labelForm">Libellé</label>
...
export default DocumentCautionForm;
