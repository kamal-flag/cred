...
import {
  ...
  schemaBureauDouanierValidation,
...
function BureauDouanierForm({
  ...
  const {
    ...
    resolver: yupResolver(schemaBureauDouanierValidation),
  });
  ...
  return (
    <Modal
      titleModal="Formulaire des bureaux douaniers"
      openModal={showModal}
...
export default BureauDouanierForm;
