...
function AssuranceForm({ action, url, data, closeModal, dataReturned }: Props) {
  ...
  const {
    ...
    resolver: yupResolver(schemaAssuranceValidation),
  });
  ...
  return (
    <Modal
      titleModal="Formulaire des assurances"
      openModal={showModal}
